...
public interface OutboundPubSubMessageBuilder {
    ...
    /**
     * Set the {@code topicName} of the GCP Pub/Sub message. This is required to successfully build a
    ...
    /**
     * Set the data of the GCP Pub/Sub message.
     *
    ...
    /**
     * Add an attribute to the GCP Pub/Sub message. If the builder previously contained a mapping for the key, the old value
    ...
    /**
     * Add all {@code attributes} to the GCP Pub/Sub message. If the builder previously contained a mapping for a key, the
     * old value is replaced by the specified value.
     *
     * @param attributes the attributes to add to the GCP Pub/Sub message.
     * @return this builder
    ...
    /**
     * Set the orderingKey of the GCP Pub/Sub message.
     *
