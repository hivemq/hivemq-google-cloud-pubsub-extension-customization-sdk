...
The HiveMQ Google Cloud Pub/Sub Extension Customization SDK allows the programmatic interaction with the https://www.hivemq.com/extension/hivemq-gcp-pubsub-extension/[HiveMQ Enterprise Extension for Google Cloud Pub/Sub].
